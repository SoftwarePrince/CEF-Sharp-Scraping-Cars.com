...
namespace FirstScraping
{
    public partial class Form1 : Form
    {
        ...
        public void InitializeChromium()
        {
            ...
            const string initialUrl = "https://customers.accupin.com/login.php";
        ...
        private static void BrowserLoadingStateChanged(object sender, LoadingStateChangedEventArgs e)
        {
            if (!e.IsLoading)
            {
                ...
                if (!isLoggedIn)
                {
                    ...
                    var loginScript = @"document.querySelector('#username').value = 'test';
                               document.querySelector('#password').value = 'naeem1';
                ...
                else
                {
                    ...
                    var pageQueryScript = @"
                    (function(){
                        var lis = document.getElementsByClassName('form - control maxlength = ');
                        var result = [];
